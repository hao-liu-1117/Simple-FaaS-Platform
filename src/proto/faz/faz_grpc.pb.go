...
type FazServiceClient interface {
	...
	IsRegistered(ctx context.Context, in *IsRegisteredRequest, opts ...grpc.CallOption) (*IsRegisteredReply, error)
}
...
func (c *fazServiceClient) IsRegistered(ctx context.Context, in *IsRegisteredRequest, opts ...grpc.CallOption) (*IsRegisteredReply, error) {
	out := new(IsRegisteredReply)
	err := c.cc.Invoke(ctx, "/faz.FazService/IsRegistered", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FazServiceServer interface {
	...
	IsRegistered(context.Context, *IsRegisteredRequest) (*IsRegisteredReply, error)
...
func (UnimplementedFazServiceServer) IsRegistered(context.Context, *IsRegisteredRequest) (*IsRegisteredReply, error) {
...
func _FazService_IsRegistered_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IsRegisteredRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FazServiceServer).IsRegistered(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/faz.FazService/IsRegistered",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FazServiceServer).IsRegistered(ctx, req.(*IsRegisteredRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FazService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _FazService_IsRegistered_Handler,
		},
	},
